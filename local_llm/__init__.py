...
NODE_CLASS_MAPPINGS = {**_LLM_NODES, **_SET_NODES, **_CHAT_NODES, **_TOK_NODES, **_CSZ_NODES, **_LLOG_NODES}
NODE_DISPLAY_NAME_MAPPINGS = {**_LLM_NAMES, **_SET_NAMES, **_CHAT_NAMES, **_TOK_NAMES, **_CSZ_NAMES, **_LLOG_NAMES}
