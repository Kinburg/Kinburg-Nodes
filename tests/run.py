...
SUITES = [
    ...
    ("orpheus_timing", "py", TESTS / "test_orpheus_timing.py"),
    ("orpheus_detect", "py", TESTS / "test_orpheus_detect.py"),
    ("orpheus_node", "py", TESTS / "test_orpheus_node.py"),
    ...
    ("echo_align", "py", TESTS / "test_echo_align.py"),
    ("echo_plan", "py", TESTS / "test_echo_plan.py"),
    ("echo_burn", "py", TESTS / "test_echo_burn.py"),
