...
NODE_CLASS_MAPPINGS = {**_LLM_NODES, **_IC_NODES, **_IB_NODES, **_UTIL_NODES, **_TIMER_NODES, **_GI_NODES, **_RPT_NODES, **_ACCUM_NODES, **_COLLAGE_NODES, **_LOOP_NODES, **_LORA_NODES, **_PP_NODES, **_LO_NODES, **_SRV_NODES, **_CTX_NODES, **_GGUFC_NODES, **_ST_NODES, **_SS_NODES, **_GC_NODES, **_VJ_NODES, **_PV2_NODES, **_GRM_NODES, **_CDP_NODES, **_OBR_NODES, **_CRIT_NODES, **_CHM_NODES, **_MDL_NODES, **_SIR_NODES}
