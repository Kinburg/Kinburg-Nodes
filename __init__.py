...
NODE_CLASS_MAPPINGS = {**_LLM_NODES, **_IC_NODES, **_IB_NODES, **_UTIL_NODES, **_TIMER_NODES, **_GI_NODES, **_RPT_NODES, **_ACCUM_NODES, **_COLLAGE_NODES, **_LOOP_NODES, **_LORA_NODES, **_PP_NODES, **_LO_NODES, **_SRV_NODES, **_CTX_NODES, **_GGUFC_NODES, **_ST_NODES, **_SS_NODES, **_GC_NODES, **_VJ_NODES, **_PV2_NODES, **_GRM_NODES, **_CDP_NODES, **_OBR_NODES}
NODE_DISPLAY_NAME_MAPPINGS = {**_LLM_NAMES, **_IC_NAMES, **_IB_NAMES, **_UTIL_NAMES, **_TIMER_NAMES, **_GI_NAMES, **_RPT_NAMES, **_ACCUM_NAMES, **_COLLAGE_NAMES, **_LOOP_NAMES, **_LORA_NAMES, **_PP_NAMES, **_LO_NAMES, **_SRV_NAMES, **_CTX_NAMES, **_GGUFC_NAMES, **_ST_NAMES, **_SS_NAMES, **_GC_NAMES, **_VJ_NAMES, **_PV2_NAMES, **_GRM_NAMES, **_CDP_NAMES, **_OBR_NAMES}
WEB_DIRECTORY = "web"
