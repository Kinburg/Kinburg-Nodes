...
from .save_video import (
    NODE_CLASS_MAPPINGS as _SV_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _SV_NAMES,
)
...
from .phantas import (
    NODE_CLASS_MAPPINGS as _PHN_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _PHN_NAMES,
)
from .orpheus import (
    NODE_CLASS_MAPPINGS as _ORPH_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _ORPH_NAMES,
)
from .echo import (
    NODE_CLASS_MAPPINGS as _ECHO_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _ECHO_NAMES,
)
...
NODE_CLASS_MAPPINGS = {**_LLM_NODES, **_IC_NODES, **_IB_NODES, **_UTIL_NODES, **_TIMER_NODES, **_GI_NODES, **_RPT_NODES, **_ACCUM_NODES, **_COLLAGE_NODES, **_LOOP_NODES, **_LORA_NODES, **_PP_NODES, **_LO_NODES, **_SRV_NODES, **_CTX_NODES, **_GGUFC_NODES, **_ST_NODES, **_SS_NODES, **_SV_NODES, **_GC_NODES, **_VJ_NODES, **_PV2_NODES, **_GRM_NODES, **_CDP_NODES, **_OBR_NODES, **_CRIT_NODES, **_CHM_NODES, **_MDL_NODES, **_SIR_NODES, **_MRPH_NODES, **_PHN_NODES, **_ORPH_NODES, **_ASR_NODES, **_ECHO_NODES}
NODE_DISPLAY_NAME_MAPPINGS = {**_LLM_NAMES, **_IC_NAMES, **_IB_NAMES, **_UTIL_NAMES, **_TIMER_NAMES, **_GI_NAMES, **_RPT_NAMES, **_ACCUM_NAMES, **_COLLAGE_NAMES, **_LOOP_NAMES, **_LORA_NAMES, **_PP_NAMES, **_LO_NAMES, **_SRV_NAMES, **_CTX_NAMES, **_GGUFC_NAMES, **_ST_NAMES, **_SS_NAMES, **_SV_NAMES, **_GC_NAMES, **_VJ_NAMES, **_PV2_NAMES, **_GRM_NAMES, **_CDP_NAMES, **_OBR_NAMES, **_CRIT_NAMES, **_CHM_NAMES, **_MDL_NAMES, **_SIR_NAMES, **_MRPH_NAMES, **_PHN_NAMES, **_ORPH_NAMES, **_ASR_NAMES, **_ECHO_NAMES}
WEB_DIRECTORY = "web"
