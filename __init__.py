...
NODE_CLASS_MAPPINGS = {**_LLM_NODES, **_IC_NODES, **_IB_NODES, **_UTIL_NODES, **_TIMER_NODES, **_GI_NODES, **_RPT_NODES, **_ACCUM_NODES}
NODE_DISPLAY_NAME_MAPPINGS = {**_LLM_NAMES, **_IC_NAMES, **_IB_NAMES, **_UTIL_NAMES, **_TIMER_NAMES, **_GI_NAMES, **_RPT_NAMES, **_ACCUM_NAMES}
WEB_DIRECTORY = "web"
