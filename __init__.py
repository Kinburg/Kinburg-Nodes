...
from .ouroboros import (
    NODE_CLASS_MAPPINGS as _OBR_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _OBR_NAMES,
)
from .criteria_presets import (
    NODE_CLASS_MAPPINGS as _CRIT_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _CRIT_NAMES,
)
from .chimera import (
    NODE_CLASS_MAPPINGS as _CHM_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _CHM_NAMES,
)
from .model_presets import (
    NODE_CLASS_MAPPINGS as _MDL_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _MDL_NAMES,
)
from .siren import (
    NODE_CLASS_MAPPINGS as _SIR_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _SIR_NAMES,
)
from .morpheus import (
    NODE_CLASS_MAPPINGS as _MRPH_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _MRPH_NAMES,
)
from .audio_sr import (
    NODE_CLASS_MAPPINGS as _ASR_NODES,
    NODE_DISPLAY_NAME_MAPPINGS as _ASR_NAMES,
)

NODE_CLASS_MAPPINGS = {**_LLM_NODES, **_IC_NODES, **_IB_NODES, **_UTIL_NODES, **_TIMER_NODES, **_GI_NODES, **_RPT_NODES, **_ACCUM_NODES, **_COLLAGE_NODES, **_LOOP_NODES, **_LORA_NODES, **_PP_NODES, **_LO_NODES, **_SRV_NODES, **_CTX_NODES, **_GGUFC_NODES, **_ST_NODES, **_SS_NODES, **_GC_NODES, **_VJ_NODES, **_PV2_NODES, **_GRM_NODES, **_CDP_NODES, **_OBR_NODES, **_CRIT_NODES, **_CHM_NODES, **_MDL_NODES, **_SIR_NODES, **_MRPH_NODES, **_ASR_NODES}
NODE_DISPLAY_NAME_MAPPINGS = {**_LLM_NAMES, **_IC_NAMES, **_IB_NAMES, **_UTIL_NAMES, **_TIMER_NAMES, **_GI_NAMES, **_RPT_NAMES, **_ACCUM_NAMES, **_COLLAGE_NAMES, **_LOOP_NAMES, **_LORA_NAMES, **_PP_NAMES, **_LO_NAMES, **_SRV_NAMES, **_CTX_NAMES, **_GGUFC_NAMES, **_ST_NAMES, **_SS_NAMES, **_GC_NAMES, **_VJ_NAMES, **_PV2_NAMES, **_GRM_NAMES, **_CDP_NAMES, **_OBR_NAMES, **_CRIT_NAMES, **_CHM_NAMES, **_MDL_NAMES, **_SIR_NAMES, **_MRPH_NAMES, **_ASR_NAMES}
WEB_DIRECTORY = "web"
